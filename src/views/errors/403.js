				...
				<div className="container mt-5">
					<Row align="middle">
						<Col xs={24} sm={24} md={8}>
							<h1 className="font-weight-bold mb-4 display-4">Action Restricted</h1>
							<p className="font-size-md mb-4">We've noticed you trying to access a page that you are not authorized for.</p>
							<Link to={DASHBOARD_PREFIX_PATH}>
								<Button type="primary" icon={<ArrowLeftOutlined />}>Go to dashboard</Button>
							</Link>
						</Col>
